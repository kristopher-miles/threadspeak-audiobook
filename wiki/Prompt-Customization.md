...
- `system_prompt` / `user_prompt` -> `config/prompts/default_prompts.txt`
- `review_system_prompt` / `review_user_prompt` -> `config/prompts/review_prompts.txt`
- `attribution_system_prompt` / `attribution_user_prompt` -> `config/prompts/attribution_prompts.txt`

Single prompts:
- `voice_prompt` -> `config/prompts/voice_prompt.txt`
- `dialogue_identification_system_prompt` -> `config/prompts/dialogue_identification_system_prompt.txt`
- `temperament_extraction_system_prompt` -> `config/prompts/temperament_extraction_system_prompt.txt`
...
- `GET /api/default_prompts`
  - Returns defaults from current editable prompt files in `config/prompts/` (not the factory bundle).
...
- Editable prompt files live under `config/prompts/`.
